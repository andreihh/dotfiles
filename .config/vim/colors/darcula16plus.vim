...
"
" Uses 17 color palette: the 16 default ANSI colors and requires an external
" background darker than ANSI black.
...
hi PmenuSel ctermfg=15 ctermbg=0 cterm=inverse,nocombine
