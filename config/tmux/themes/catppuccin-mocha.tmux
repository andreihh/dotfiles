# catppuccin-mocha.tmux: configures `tmux` theme.

set -g @fg '#cdd6f4'  # text
set -g @reverse_fg '#1e1e2e'  # base
set -g @highlight_bg '#45475a'  # surface1
